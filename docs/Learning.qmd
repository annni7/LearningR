...
post_meal_data |>
  mutate(
    ...
    insulin_insensitive = if_else(insulin_glucose_ratio >
      mean(insulin_glucose_ratio), "Insensitive", "Sensitive")
  ) |>
...
post_meal_data |>
  ...
  summarise(
    "AUC c-Peptide" = median(round(auc_cp), 1),
    "AUC Glukose" = median(round(auc_pg), 1),
    "AUC Insulin" = median(round(auc_ins), 1)
  ) |>
  # Task 5.
  rename(
    "Age group" = age_group,
